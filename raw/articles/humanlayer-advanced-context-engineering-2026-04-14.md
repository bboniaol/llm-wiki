# Raw Source: Advanced context engineering

- Original URL: https://www.humanlayer.dev/blog/advanced-context-engineering
- Retrieved via: https://r.jina.ai/http://https://www.humanlayer.dev/blog/advanced-context-engineering
...
URL Source: https://www.humanlayer.dev/blog/advanced-context-engineering

Published Time: 08/29/2025

Markdown Content:
# Advanced Context Engineering for Coding Agents | HumanLayer Blog

[humanlayer](https://www.humanlayer.dev/)
*   [Learn](https://www.humanlayer.dev/#learn-more)
*   |
*   [GitHub](https://github.com/humanlayer/humanlayer)
*   |
*   [Discord](https://www.humanlayer.dev/discord)
*   |
*   [Jobs](https://www.humanlayer.dev/jobs)
*   |
...
[#agents](https://www.humanlayer.dev/blog/tags/agents)[#claudecode](https://www.humanlayer.dev/blog/tags/claudecode)[#best-practices](https://www.humanlayer.dev/blog/tags/best-practices)
...
![Image 1: Rework](https://www.humanlayer.dev/blog/advanced-context-engineering/ai-software-rework.png)
...
![Image 2: Productivity](https://www.humanlayer.dev/blog/advanced-context-engineering/ai-software-productivity.png)
...
Again, this is all built around a workflow we call [frequent intentional compaction](https://www.humanlayer.dev/blog/advanced-context-engineering#what-works-even-better-frequent-intentional-compaction) - essentially designing your entire development process around context management, keeping utilization in the 40-60% range, and building in high-leverage human review at exactly the right points. We use a "research, plan, implement" workflow, but the core capabilities/learnings here are FAR more general than any specific workflow or set of prompts.
...
![Image 3: Re-Steering](https://www.humanlayer.dev/blog/advanced-context-engineering/re-steering.png)
...
![Image 4: Intentional Compaction](https://www.humanlayer.dev/blog/advanced-context-engineering/intentional-compaction.png)
...
![Image 5: Compaction Output](https://www.humanlayer.dev/blog/advanced-context-engineering/output.png)
...
![Image 6: Context is Everything](https://www.humanlayer.dev/blog/advanced-context-engineering/context-is-everything.png)
...
![Image 7: Equation](https://www.humanlayer.dev/blog/advanced-context-engineering/equation.png)
...
![Image 8: Sub-Agents](https://www.humanlayer.dev/blog/advanced-context-engineering/sub-agents.png)

The ideal subagent response probably looks similar to the ideal ad-hoc compaction from above

![Image 9: Compaction Output](https://www.humanlayer.dev/blog/advanced-context-engineering/output.png)

Getting a subagent to return this is not trivial:

![Image 10: Telephone](https://www.humanlayer.dev/blog/advanced-context-engineering/telephone.png)
...
![Image 11: Workflow](https://www.humanlayer.dev/blog/advanced-context-engineering/workflow.png)
...
![Image 12: Quality Cascade](https://www.humanlayer.dev/blog/advanced-context-engineering/cascade.png)

So you want to **focus human effort and attention** on the HIGHEST LEVERAGE parts of the pipeline.

![Image 13: Hierarchy of Leverage](https://www.humanlayer.dev/blog/advanced-context-engineering/leverage.png)
...
![Image 14: Code Review Hierarchy of Needs](https://www.humanlayer.dev/blog/advanced-context-engineering/code-review-hierarchy-of-needs.png)
...
[← Newer ### Writing a good CLAUDE.md November 25, 2025 · 10 min read `CLAUDE.md` is a high-leverage configuration point for Claude Code. Learning how to write a good `CLAUDE.md` (or `AGENTS.md`) is a key skill for agent-enabled software engineering.](https://www.humanlayer.dev/blog/writing-a-good-claude-md)[Older → ### 12 Factor Agents April 3, 2025 · 32 min read The Original **12 Factor Agents** Manifesto. What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?](https://www.humanlayer.dev/blog/12-factor-agents)

[Company Overview](https://www.ycombinator.com/companies/humanlayer) | [Careers](https://www.ycombinator.com/companies/humanlayer/jobs) | [Terms of Use](https://www.humanlayer.dev/legal/terms.html) | [Privacy Policy](https://www.humanlayer.dev/legal/privacy-policy.html) | [GitHub](https://github.com/humanlayer/humanlayer) | [X](https://twitter.com/humanlayer_dev) | [Discord](https://www.humanlayer.dev/discord) | [YouTube](https://youtube.com/@humanlayerdev)
