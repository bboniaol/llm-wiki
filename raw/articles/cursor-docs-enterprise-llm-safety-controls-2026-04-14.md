...
URL Source: https://www.cursor.com/docs/enterprise/llm-safety-and-controls
...
## [Understanding model behavior](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#understanding-model-behavior)
...
## [Two approaches to safety](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#two-approaches-to-safety)
...
## [Security controls](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#security-controls)

These deterministic controls enforce hard boundaries on what agents can do. They work regardless of what the LLM suggests.

### [Terminal command restrictions](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#terminal-command-restrictions)
...
#### [Auto-approval risks](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#auto-approval-risks)
...
#### [Auto-run configuration](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#auto-run-configuration)
...
### [Enforcement hooks](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#enforcement-hooks)
...
#### [Example: Blocking git commands](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#example-blocking-git-commands)

This hook intercepts shell commands and blocks raw git usage, directing users to the GitHub CLI instead:

#### [Example: Redacting secrets](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#example-redacting-secrets)
...
### [Protecting sensitive files](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#protecting-sensitive-files)
...
#### [.cursorignore](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#cursorignore)
...
#### [.cursor directory protection](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#cursor-directory-protection)
...
#### [Browser origin controls](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#browser-origin-controls)
...
### [Integration with DLP tools](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#integration-with-dlp-tools)
...
#### [Endpoint DLP agents](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#endpoint-dlp-agents)
...
#### [Hooks-based DLP](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#hooks-based-dlp)

Use Cursor's hooks feature to implement custom DLP logic:

**Before prompt submission:** Scan prompts for sensitive patterns before sending to LLMs:

**After code generation:** Scan generated code before it's written to disk:

#### [Third-party DLP integration](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#third-party-dlp-integration)
...
### [Approval workflows](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#approval-workflows)
...
### [Model provider safety](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#model-provider-safety)
...
### [Sandboxing considerations](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#sandboxing-considerations)
...
#### [Sandboxing options](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#sandboxing-options)
...
### [File system permissions](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#file-system-permissions)

For further defense, use file system permissions to protect sensitive files:

**Restrict access to secret files:**

**Separate sensitive repos:** Keep highly sensitive code in separate repositories with restricted access. Don't clone these repositories to machines where Cursor runs.

**Encrypted filesystems:** For very sensitive data, use encrypted filesystems that require explicit mounting. Don't mount these filesystems in directories where Cursor has access.

## [LLM steering](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#llm-steering)
...
### [Rules](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#rules)
...
### [Commands and workflows](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#commands-and-workflows)
...
### [Context enrichment with MCPs](https://www.cursor.com/docs/enterprise/llm-safety-and-controls#context-enrichment-with-mcps)
