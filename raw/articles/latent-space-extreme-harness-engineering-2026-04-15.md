...
- Original URL: https://latent.space/p/harness-eng
- Retrieved via: https://r.jina.ai/http://https://latent.space/p/harness-eng
- Retrieved on: 2026-04-15
- Publisher: Latent.Space
- Type: long-form article / podcast transcript
- Main claim: OpenAI Frontier 与 Symphony 展示了一种 extreme harness engineering 形态：以 >1M LOC、>1B tokens/day、零人工写码、接近零人工 pre-merge review 为边界条件，把 coding agents 从 copilot 推到 autonomous implementation runs，并把人类职责上移到 specs、workflow、observability、review surfaces 与 trust design。
- Key signals:
  - Frontier 团队在 5 个月内构建 >1M LOC、上千 PR 的内部产品，主张人类应停止盯代码细节，转而构建让 agent 自主 review / merge 的系统
  - Symphony 被描述为 orchestration layer / ghost library，用于把 ticket work 变成 isolated autonomous runs
  - 构建速度的关键约束不是 token，而是 human attention 与 build-loop latency
  - worktrees、merge conflicts、PR lifecycle、skills、specs、Grafana dashboards、on-call tooling、Slack workflows 都被重构成 agent-legible assets
...
URL Source: https://latent.space/p/harness-eng

Published Time: 2026-04-07T17:14:26+00:00

Markdown Content:
_We’re proud to release this ahead of [Ryan’s keynote at AIE Europe](https://www.youtube.com/watch?v=O\_IMsEg91g8). Hit the bell, get notified when it is live! Attendees: come prepped for [Ryan’s AMA with Vibhu after](https://www.ai.engineer/schedule)._
...
[![Image 1](https://substackcdn.com/image/fetch/$s_!iz_m!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fffccec93-8328-437b-9974-c2df897604cc_1508x1592.png)](https://substackcdn.com/image/fetch/$s_!iz_m!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fffccec93-8328-437b-9974-c2df897604cc_1508x1592.png)
